...
double maths::length(const vector3 & v)
{
...
mat4x4 maths::createProjectionMatrix(float FOV, float NEAR_PLANE, float FAR_PLANE,int width,int height)
{
